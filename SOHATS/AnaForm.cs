...
namespace SOHATS
{
    public partial class AnaForm : Form
    {
        ...
        {
            formControl.Open(new PoliklinikEkle(this,formControl));
        }

        private void kullanıcıTanıtma_Click(object sender, EventArgs e)
        {
            formControl.Open(new KullaniciEkle(this, formControl));
        }
        ...
        private void hastaİşlemleriToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                formControl.Open(new HastaIslemleri(this, formControl));
            }
        }
